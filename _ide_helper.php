 ...
 * Generated for Laravel Lumen (5.4.6) (Laravel Components 5.4.*) on 2017-06-17.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        {
            return \Laravel\Lumen\Application::make($abstract);
        }
        ...
        {
            return \Laravel\Lumen\Application::mergeGroup($new, $old);
        }
        ...
        {
            \Laravel\Lumen\Application::addRoute($method, $uri, $action);
        }
        ...
        {
            return \Laravel\Lumen\Application::hasGroupStack();
        }
